...
Final_SP = strcat ('C:/Users/RaviHome/Desktop/SEP/Code/Data/Stability Period/VaryNodes/data_final_LEACH', '.txt');  
File_SP = fopen (Final_SP, 'w');

Final_File_Name_AFrac = strcat ('C:/Users/RaviHome/Desktop/SEP/Code/Data/Fraction Of Nodes Cluster Heads/VaryNodes/data_final_LEACH', '.txt');    
Final_File_AFrac = fopen (Final_File_Name_AFrac, 'w');

Final_File_Name_AveStdResEnergy = 'C:/Users/RaviHome/Desktop/SEP/Code/Data/Standard Deviation Residual Energy/VaryNodes/data_final_LEACH.txt';        
Final_File_AveStdDevResEnergy = fopen (Final_File_Name_AveStdResEnergy, 'w');


Final_File_Name_AveCHE = strcat ('C:/Users/RaviHome/Desktop/SEP/Code/Data/Cluster Head Energy/VaryNodes/data_final_LEACH.txt');    
